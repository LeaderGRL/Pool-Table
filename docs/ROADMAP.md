...
Current Phase 6 work is **Rendering: Rebuild pool-table PBR materials** (issue #104). URP installation/configuration is merged through PR #87, legacy material conversion is merged through PR #103, and stabilization steps 40G–40I are merged through PR #101 and manually validated. Before every new issue, review this roadmap and verify the current status from repository, test, or merged-PR evidence.

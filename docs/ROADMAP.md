...
Current Phase 4 work is **Physics: Implement cue-ball spin** (issue #60). After it is merged, continue with **Physics: Implement rail collision response**. Before every new issue, review this roadmap and verify the current status from repository, test, or merged-PR evidence.
